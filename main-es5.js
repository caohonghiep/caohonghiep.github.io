...
/*!**********************************************!*\
  !*** ./src/app/sub-modules/ic-core/index.ts ***!
  \**********************************************/
/*! exports provided: ConfirmDialog, DialogService, providers, IcCoreModule, HeaderComponent, PageLoaderComponent, NavComponent, ChipsAutocompleteComponent, AlertDialog, AbstractPageComponent, PageLoaderService, UtilityService, InitializerProvider, AbstractDao, AbstractApi, AbstractRepository, Address, Contact, Customer, Phone, CustomerProfile */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var AbstractRepository = /** @class */ (function () {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        if (!(this.icConfig.dataMode !== 'offline')) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.api.create(t)];
                    case 1:
                        t = _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.dao.create(t)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.dao.update(t)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.dao.replace(t)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.dao.delete(id)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    AbstractRepository.prototype.search = function (query) {
        ...
        var observable = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"](function (observer) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dao.search({
                            fullName: {
                    ...
                    case 1:
                        ...
                        if (!(this.icConfig.dataMode !== 'offline')) return [3 /*break*/, 3];
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        observer.next(t);
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.dao.get(id)];
                    case 3:
                        t = _a.sent();
                        observer.next(t);
                        _a.label = 4;
